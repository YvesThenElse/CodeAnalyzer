...
function Header() {
  ...
  }, [graph2?.rootPath, setLoading, setProgress, setGraph, setError]);
  return /* @__PURE__ */ React$2.createElement("div", { className: "header" }, /* @__PURE__ */ React$2.createElement("div", { className: "header__logo" }, "ReactAnalyzer"), /* @__PURE__ */ React$2.createElement("div", { className: "header__actions" }, /* @__PURE__ */ React$2.createElement(
    "button",
    {
    ...
    "Rafraîchir"
  )), graph2 && /* @__PURE__ */ React$2.createElement("div", { className: "header__info" }, /* @__PURE__ */ React$2.createElement("span", { className: "header__project-name" }, graph2.name), /* @__PURE__ */ React$2.createElement("span", { className: "header__file-count" }, graph2.files.size, " fichiers")));
}
...
function ClusteringToggle() {
  ...
  return /* @__PURE__ */ React$2.createElement(
    ...
    /* @__PURE__ */ React$2.createElement(
      ...
      /* @__PURE__ */ React$2.createElement("span", { style: { color: "#64748b" } }, "Grouper")
    ),
    showClusters && /* @__PURE__ */ React$2.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      /* @__PURE__ */ React$2.createElement(
        "button",
        {
          ...
          style: {
            ...
            backgroundColor: clusteringMode === ClusteringMode.FOLDER ? "#ffffff" : "transparent",
            color: clusteringMode === ClusteringMode.FOLDER ? "#1e40af" : "#64748b",
            boxShadow: clusteringMode === ClusteringMode.FOLDER ? "0 1px 2px rgba(0,0,0,0.05)" : "none",
            transition: "all 0.15s ease"
          }
        },
        "Par dossier"
      ...
      /* @__PURE__ */ React$2.createElement(
        "button",
        {
          ...
          style: {
            ...
            backgroundColor: clusteringMode === ClusteringMode.COMMUNITY ? "#ffffff" : "transparent",
            color: clusteringMode === ClusteringMode.COMMUNITY ? "#1e40af" : "#64748b",
            boxShadow: clusteringMode === ClusteringMode.COMMUNITY ? "0 1px 2px rgba(0,0,0,0.05)" : "none",
            transition: "all 0.15s ease"
          }
        },
        "Par liens"
...
function NodeDetailsPanel() {
  const { graph: graph2, currentLevel, selectedFileId, selectedNodeId, setSelectedNodeId } = useGraphStore();
  if (!graph2 || !selectedNodeId) {
    return null;
  }
  if (currentLevel === GraphLevel.FILES) {
    const file = graph2.files.get(selectedNodeId);
    if (!file) return null;
    return /* @__PURE__ */ React$2.createElement(FileDetailsPanel, { file, graph: graph2, onClose: () => setSelectedNodeId(null) });
  }
...
function FileDetailsPanel({ file, graph: graph2, onClose }) {
  ...
  const importedBy = graph2 ? Array.from(graph2.files.values()).filter(
    (f2) => f2.imports.some((imp) => imp.resolvedFileId === file.id)
  ) : [];
  const importsFiles = file.imports.map((imp) => graph2 ? graph2.files.get(imp.resolvedFileId) : null).filter((f2) => f2 !== null);
...
function App() {
  ...
  return /* @__PURE__ */ React$2.createElement(ReactFlowProvider, null, /* @__PURE__ */ React$2.createElement("div", { className: "app" }, /* @__PURE__ */ React$2.createElement("header", { className: "app__header" }, /* @__PURE__ */ React$2.createElement(Header, null)), /* @__PURE__ */ React$2.createElement("nav", { className: "app__toolbar" }, /* @__PURE__ */ React$2.createElement(BackButton, null), /* @__PURE__ */ React$2.createElement(ClusteringToggle, null)), /* @__PURE__ */ React$2.createElement("div", { className: "app__main" }, /* @__PURE__ */ React$2.createElement(FileTreePanel, null), /* @__PURE__ */ React$2.createElement("main", { className: "app__content" }, /* @__PURE__ */ React$2.createElement(DiagramView, null)), /* @__PURE__ */ React$2.createElement(NodeDetailsPanel, null)), isLoading && /* @__PURE__ */ React$2.createElement(LoadingOverlay, null)));
}
