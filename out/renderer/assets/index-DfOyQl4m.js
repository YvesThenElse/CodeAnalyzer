    ...
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ React$2.createElement(
        ...
        /* @__PURE__ */ React$2.createElement(
          ...
          /* @__PURE__ */ React$2.createElement("div", { style: { fontSize: "48px", marginBottom: "16px" } }, "⚠️"),
...
const useGraphStore = create((set2, get2) => ({
  ...
  setHoveredLogicNodeId: (id2) => set2({ hoveredLogicNodeId: id2 }),
  setSelectedLogicNodeId: (id2) => set2({ selectedLogicNodeId: id2 }),
  getLogicNodeLine: (nodeId) => {
    const { functionLogic } = get2();
    if (!functionLogic) return null;
    const node = functionLogic.nodes.find((n2) => n2.id === nodeId);
...
function LLMConfigModal({ open, onClose }) {
  ...
  )), /* @__PURE__ */ React$2.createElement("div", { className: "form-group" }, /* @__PURE__ */ React$2.createElement("label", { htmlFor: "model" }, "Modèle"), /* @__PURE__ */ React$2.createElement("select", { id: "model", value: model, onChange: (e) => setModel(e.target.value) }, LLM_MODELS[provider].map((m2) => /* @__PURE__ */ React$2.createElement("option", { key: m2, value: m2 }, m2)))), provider !== "ollama" && /* @__PURE__ */ React$2.createElement("div", { className: "form-group" }, /* @__PURE__ */ React$2.createElement("label", { htmlFor: "apiKey" }, "Clé API"), /* @__PURE__ */ React$2.createElement(
    "input",
    {
      id: "apiKey",
      type: "password",
  ...
  ), testStatus === "success" && /* @__PURE__ */ React$2.createElement("span", { className: "test-status test-status--success" }, "Connexion réussie"), testStatus === "error" && /* @__PURE__ */ React$2.createElement("span", { className: "test-status test-status--error" }, testError))), /* @__PURE__ */ React$2.createElement("div", { className: "modal__footer" }, /* @__PURE__ */ React$2.createElement("button", { className: "btn btn--secondary", onClick: onClose }, "Annuler"), /* @__PURE__ */ React$2.createElement(
    "button",
    {
...
function DescriptionUpdateModal({
  open,
  pendingCount,
  onConfirm,
  onCancel
  ...
  if (!open) return null;
  return /* @__PURE__ */ React$2.createElement("div", { className: "modal-overlay", onClick: onCancel }, /* @__PURE__ */ React$2.createElement("div", { className: "modal description-update-modal", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React$2.createElement("div", { className: "modal__header" }, /* @__PURE__ */ React$2.createElement("h2", null, "Mise à jour des descriptions IA"), /* @__PURE__ */ React$2.createElement("button", { className: "modal__close", onClick: onCancel }, "×")), /* @__PURE__ */ React$2.createElement("div", { className: "modal__content" }, /* @__PURE__ */ React$2.createElement("p", { className: "description-update-modal__message" }, /* @__PURE__ */ React$2.createElement("strong", null, pendingCount), " fichier", pendingCount > 1 ? "s" : "", " ", pendingCount > 1 ? "nécessitent" : "nécessite", " une mise à jour des descriptions IA."), /* @__PURE__ */ React$2.createElement("p", { className: "description-update-modal__info" }, "Cette opération utilise votre configuration LLM pour générer des descriptions automatiques des fichiers."), /* @__PURE__ */ React$2.createElement("p", { className: "description-update-modal__warning" }, "Attention : cette opération peut engendrer des coûts selon votre fournisseur LLM.")), /* @__PURE__ */ React$2.createElement("div", { className: "modal__footer" }, /* @__PURE__ */ React$2.createElement("button", { className: "btn btn--outline", onClick: onCancel }, "Ignorer"), /* @__PURE__ */ React$2.createElement("button", { className: "btn btn--primary", onClick: onConfirm }, "Mettre à jour"))));
}
function Header() {
  const {
    graph: graph2,
  ...
  const [updateModalOpen, setUpdateModalOpen] = reactExports.useState(false);
  const [pendingFilesCount, setPendingFilesCount] = reactExports.useState(0);
  reactExports.useEffect(() => {
    ...
    if (graph2?.rootPath) {
      window.electronAPI.llm.getConfig(graph2.rootPath).then((config) => {
        ...
        window.electronAPI.llm.getDescriptions(graph2.rootPath).then((descriptions2) => {
          ...
          if (config) {
            window.electronAPI.llm.countPendingFiles(graph2.rootPath).then((count) => {
              if (count > 0) {
  ...
  }, [graph2?.rootPath, setLLMConfig, setDescriptions]);
  ...
  const handleUpdateConfirm = reactExports.useCallback(() => {
    setUpdateModalOpen(false);
    handleGenerateDescriptions(false);
  }, [handleGenerateDescriptions]);
  const handleUpdateCancel = reactExports.useCallback(() => {
    setUpdateModalOpen(false);
  }, []);
...
function Breadcrumb() {
  ...
  return /* @__PURE__ */ React$2.createElement("div", { style: containerStyle2 }, /* @__PURE__ */ React$2.createElement(
    ...
    /* @__PURE__ */ React$2.createElement("span", { style: { marginRight: "6px" } }, "📄"),
    file.fileName
  ) : /* @__PURE__ */ React$2.createElement("span", { style: currentStyle }, /* @__PURE__ */ React$2.createElement("span", { style: { marginRight: "6px" } }, "📄"), file.fileName)), currentLevel === GraphLevel.FUNCTION_LOGIC && selectedFunction && /* @__PURE__ */ React$2.createElement(React$2.Fragment, null, /* @__PURE__ */ React$2.createElement("span", { style: separatorStyle }, "›"), /* @__PURE__ */ React$2.createElement("span", { style: currentStyle }, /* @__PURE__ */ React$2.createElement("span", { style: { marginRight: "6px" } }, "ƒ"), selectedFunction.name, "()")));
}
...
function FunctionCodePanel() {
  ...
  const [panelWidth, setPanelWidth] = reactExports.useState(() => {
    ...
    return stored ? Math.max(PANEL_MIN_WIDTH$1, parseInt(stored, 10)) : PANEL_DEFAULT_WIDTH$1;
  });
  const [isResizing, setIsResizing] = reactExports.useState(false);
  const [wrapLines, setWrapLines] = reactExports.useState(() => {
  ...
  reactExports.useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      const newWidth = Math.max(PANEL_MIN_WIDTH$1, window.innerWidth - e.clientX);
  ...
  const highlightedLine = reactExports.useMemo(() => {
  ...
  const renderLineContent = reactExports.useCallback((line) => {
    if (!line) return " ";
    ...
    if (singleLineCommentIndex !== -1) {
      ...
      if (quoteCount % 2 === 0) {
        ...
        return /* @__PURE__ */ React$2.createElement(React$2.Fragment, null, code, /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__comment" }, comment));
      }
    }
    ...
    if (blockCommentStart !== -1) {
      ...
      if (blockCommentEnd !== -1 && blockCommentEnd > blockCommentStart) {
        ...
        return /* @__PURE__ */ React$2.createElement(React$2.Fragment, null, beforeComment, /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__comment" }, comment), afterComment);
      } else {
        const comment = line.substring(blockCommentStart);
        return /* @__PURE__ */ React$2.createElement(React$2.Fragment, null, beforeComment, /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__comment" }, comment));
      }
    }
    const trimmed = line.trim();
    if (trimmed.startsWith("*") || trimmed.startsWith("*/")) {
      return /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__comment" }, line);
    }
    return line;
  }, []);
  if (!functionLogic) {
  ...
  return /* @__PURE__ */ React$2.createElement(
    ...
    /* @__PURE__ */ React$2.createElement("div", { className: "function-code-panel__resize-handle", onMouseDown: handleResizeStart }),
    /* @__PURE__ */ React$2.createElement("header", { className: "function-code-panel__header" }, /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__title" }, "Code source"), /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__function-name" }, functionName, "()")),
    /* @__PURE__ */ React$2.createElement("div", { className: "function-code-panel__content", ref: contentRef }, lines.map((line, index2) => {
      const lineNumber = startLine + index2;
      return /* @__PURE__ */ React$2.createElement(
        "div",
        {
          key: index2,
        ...
        /* @__PURE__ */ React$2.createElement("span", { className: "function-code-panel__line-number" }, lineNumber),
        /* @__PURE__ */ React$2.createElement("code", { className: `function-code-panel__code${wrapLines ? " function-code-panel__code--wrap" : ""}` }, renderLineContent(line))
      );
    })),
    /* @__PURE__ */ React$2.createElement("footer", { className: "function-code-panel__footer" }, /* @__PURE__ */ React$2.createElement("label", { className: "function-code-panel__checkbox" }, /* @__PURE__ */ React$2.createElement(
      "input",
      {
        type: "checkbox",
        checked: wrapLines,
...
function EmptyPanel() {
  return /* @__PURE__ */ React$2.createElement("aside", { className: "node-details-panel" }, /* @__PURE__ */ React$2.createElement("header", { className: "node-details-panel__header node-details-panel__header--empty" }, /* @__PURE__ */ React$2.createElement("div", { className: "node-details-panel__header-content" }, /* @__PURE__ */ React$2.createElement("h2", { className: "node-details-panel__title" }, "Détails"))), /* @__PURE__ */ React$2.createElement("div", { className: "node-details-panel__content" }, /* @__PURE__ */ React$2.createElement("div", { className: "node-details-panel__empty" }, /* @__PURE__ */ React$2.createElement("span", { className: "node-details-panel__empty-icon" }, "📋"), /* @__PURE__ */ React$2.createElement("p", null, "Sélectionnez un élément pour voir ses détails"))));
}
function NodeDetailsPanel() {
  ...
  if (currentLevel === GraphLevel.FUNCTION_LOGIC) {
    return /* @__PURE__ */ React$2.createElement(FunctionCodePanel, null);
  }
  return /* @__PURE__ */ React$2.createElement(EmptyPanel, null);
}
...
function ErrorDisplay() {
  ...
  return /* @__PURE__ */ React$2.createElement(
    ...
    /* @__PURE__ */ React$2.createElement("span", { style: { fontSize: "20px" } }, "⚠️"),
...
function App() {
  ...
  return /* @__PURE__ */ React$2.createElement(ErrorBoundary, null, /* @__PURE__ */ React$2.createElement(ReactFlowProvider, null, /* @__PURE__ */ React$2.createElement("div", { className: "app" }, /* @__PURE__ */ React$2.createElement("header", { className: "app__header" }, /* @__PURE__ */ React$2.createElement(Header, null)), /* @__PURE__ */ React$2.createElement("div", { className: "app__main" }, /* @__PURE__ */ React$2.createElement(FileTreePanel, null), /* @__PURE__ */ React$2.createElement("main", { className: "app__content" }, /* @__PURE__ */ React$2.createElement("div", { style: { position: "absolute", top: "16px", left: "16px", zIndex: 10 } }, /* @__PURE__ */ React$2.createElement(BackButton, null)), /* @__PURE__ */ React$2.createElement("div", { style: { position: "absolute", bottom: "16px", left: "60px", zIndex: 10 } }, /* @__PURE__ */ React$2.createElement(Breadcrumb, null)), /* @__PURE__ */ React$2.createElement(DiagramView, null)), /* @__PURE__ */ React$2.createElement(NodeDetailsPanel, null)), isLoading && /* @__PURE__ */ React$2.createElement(LoadingOverlay, null), /* @__PURE__ */ React$2.createElement(ErrorDisplay, null))));
}
